...
static status_t LSM303AGR_MAG_ReadReg( void *handle, u8_t Reg, u8_t* Data ) 
{
  if (LSM303AGR_IO_Read(handle, Reg, Data, 1))
  {
    return MEMS_ERROR;
  }
  else
...
static status_t LSM303AGR_MAG_WriteReg( void *handle, u8_t Reg, u8_t Data ) 
{
  if (LSM303AGR_IO_Write(handle, Reg, &Data, 1))
  {
    return MEMS_ERROR;
  }
  else
...
{
  if (LSM303AGR_IO_Read(handle, Reg, Data, len))
  {
    return MEMS_ERROR;
  }
  else
...
{
  if (LSM303AGR_IO_Write(handle, Reg, &Data, len))
  {
    return MEMS_ERROR;
  }
  else
